...
ONLINE_HOSTS_URL="https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/fakenews-gambling-social/hosts"
...
# Display macOS notification
osascript -e 'display notification "... using noHox" with title "✅ Hosts file Updated"'